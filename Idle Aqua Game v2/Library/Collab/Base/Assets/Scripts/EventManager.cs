...
public class EventManager : MonoBehaviour
{
    ...
    {
        var dt = new DateTime(DateTime.Now.Year, DateTime.Now.Month, /*DateTime.Now.Day*/ 1);   //TODO Kanonika xrisimopoioumai afto sta sxolia, allios 0 = monday, 1 = tuesday
    ...
    public void Update()    //TODO polla pragmata mesa stin update, na elenxtoun sto telos tou tutorial
    {
        ...
        eventTokensText.text = $"Tokens: {game.NotationMethod(data.eventTokens, "F2")} ({game.NotationMethod(eventTokenBoost, "F2")}x)";
    ...
    private void CompleteEvent(int id)
    {
        ...
        eventRewardText.text = $"+{game.NotationMethod(reward[id], "F2")} Tokens";
    ...
    private void RunEventUI(int id)
    {
        ...
        if (data.eventActiveID != id + 1) return;
        {
            ...
            rewardText[id].text = $"+{game.NotationMethod(reward[id], "F2")} Tokens";
            currencyText[id].text = $"{game.NotationMethod(currencies[id], "F2")} Event-Coins";
